-- =============================================================================
-- Migration: Apply RLS Security Fixes
-- Purpose  : Apply security fixes to overly permissive RLS policies
--
-- This migration should be run after the initial RLS policies to ensure
